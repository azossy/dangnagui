...
> 임금님귀 v1.2.2 · copyright by 챠리 (challychoi@me.com)
...
**[dangnagui-setup-v1.2.2.exe](https://github.com/azossy/dangnagui/releases/latest)** 다운로드 → 실행 → 완료!
...
- [Inno Setup 6](https://jrsoftware.org/isinfo.php) 설치 시 `Output\dangnagui-setup-v1.2.2.exe` 인스톨러 자동 생성
